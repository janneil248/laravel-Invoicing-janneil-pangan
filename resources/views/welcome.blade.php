...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-img dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="ml-4 text-lg font-semibold">
                            <h1 style="font-size:4em">PANGAN INVOICING SYSTEM</h1>
                        </div>
                    </div>
            ...
            <di"v style=" position: absolute; bottom: 8px; right: 16px;">
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                   PANGAN API PROJECT v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
                </div>
            </div>
        </div>
    </div>
